...
@Component({
    selector: 'app-percentage-of-quantity',
    templateUrl: './percentage-of-quantity.component.html',
    styleUrls: ['./percentage-of-quantity.component.scss'],
    standalone: true,
    imports: [IonicModule, CommonModule, FormsModule, ReactiveFormsModule],
})
export class PercentageOfQuantityComponent  implements OnInit {
    ...
    calculate() {
        ...
        this.result = String(currentCalculatedNumber * currentPercentage/100).replace('.', ',');
    }
