...
@Component({
    selector: 'app-decrease-value-by-percentage',
    templateUrl: './decrease-value-by-percentage.component.html',
    styleUrls: ['./decrease-value-by-percentage.component.scss'],
    standalone: true,
    imports: [IonicModule, CommonModule, FormsModule, ReactiveFormsModule],
})
export class DecreaseValueByPercentageComponent  implements OnInit {
