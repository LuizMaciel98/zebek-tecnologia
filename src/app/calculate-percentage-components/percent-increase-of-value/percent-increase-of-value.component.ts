...
@Component({
    selector: 'app-percent-increase-of-value',
    templateUrl: './percent-increase-of-value.component.html',
    styleUrls: ['./percent-increase-of-value.component.scss'],
    standalone: true,
    imports: [IonicModule, CommonModule, FormsModule, ReactiveFormsModule],
})
export class PercentIncreaseOfValueComponent  implements OnInit {
    ...
    calculate() {
        ...
        let secondStep = (firstStep * 10 * 10 - 100);
